...
Original file is located at
    https://colab.research.google.com/drive/118Zg7iYrDPkL7yudah4_0XiD2GakpZGc
"""
...
# demo = gr.Interface(fn=purchase_book, inputs='text', outputs='text')
# demo.launch()

# df2

# df['Quantity'][0]  = df['Quantity'][0] + 1
